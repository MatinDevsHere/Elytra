...
fn default_dimension_codec() -> Tag {
    ...
    let mut dimension_type_value = HashMap::new();
    {
        ...
        overworld.insert("piglin_safe".to_string(), Tag::Byte(0));
        overworld.insert("natural".to_string(), Tag::Byte(1));
        overworld.insert("ambient_light".to_string(), Tag::Float(0.0));
        overworld.insert(
            "infiniburn".to_string(),
            Tag::String("minecraft:infiniburn_overworld".to_string()),
        );
        overworld.insert("respawn_anchor_works".to_string(), Tag::Byte(0));
        overworld.insert("has_skylight".to_string(), Tag::Byte(1));
        overworld.insert("bed_works".to_string(), Tag::Byte(1));
        overworld.insert(
            "effects".to_string(),
            Tag::String("minecraft:overworld".to_string()),
        );
        overworld.insert("has_raids".to_string(), Tag::Byte(1));
        overworld.insert("logical_height".to_string(), Tag::Int(256));
        overworld.insert("coordinate_scale".to_string(), Tag::Float(1.0));
        overworld.insert("ultrawarm".to_string(), Tag::Byte(0));
        overworld.insert("has_ceiling".to_string(), Tag::Byte(0));
        ...
        value.insert("id".to_string(), Tag::Int(0));
        value.insert("element".to_string(), Tag::Compound(overworld));

        dimension_type_value.insert("value".to_string(), Tag::List(vec![Tag::Compound(value)]));
    }
    dimension_type.insert("value".to_string(), Tag::Compound(dimension_type_value));
    root.insert(
    ...
    let mut biome_value = HashMap::new();
    {
        ...
        plains.insert("precipitation".to_string(), Tag::String("rain".to_string()));
        plains.insert("depth".to_string(), Tag::Float(0.125));
        plains.insert("temperature".to_string(), Tag::Float(0.8));
        plains.insert("scale".to_string(), Tag::Float(0.05));
        plains.insert("downfall".to_string(), Tag::Float(0.4));
        plains.insert("category".to_string(), Tag::String("plains".to_string()));
        ...
        plains.insert("effects".to_string(), Tag::Compound(effects));
        ...
        value.insert("id".to_string(), Tag::Int(0));
        value.insert("element".to_string(), Tag::Compound(plains));

        biome_value.insert("value".to_string(), Tag::List(vec![Tag::Compound(value)]));
    }
    biome_registry.insert("value".to_string(), Tag::Compound(biome_value));
    root.insert(
...
fn default_dimension() -> Tag {
    ...
    dimension.insert("piglin_safe".to_string(), Tag::Byte(0));
    dimension.insert("natural".to_string(), Tag::Byte(1));
    dimension.insert("ambient_light".to_string(), Tag::Float(0.0));
    dimension.insert(
        "infiniburn".to_string(),
        Tag::String("minecraft:infiniburn_overworld".to_string()),
    );
    dimension.insert("respawn_anchor_works".to_string(), Tag::Byte(0));
    dimension.insert("has_skylight".to_string(), Tag::Byte(1));
    dimension.insert("bed_works".to_string(), Tag::Byte(1));
    dimension.insert(
        "effects".to_string(),
        Tag::String("minecraft:overworld".to_string()),
    );
    dimension.insert("has_raids".to_string(), Tag::Byte(1));
    dimension.insert("logical_height".to_string(), Tag::Int(256));
    dimension.insert("coordinate_scale".to_string(), Tag::Float(1.0));
    dimension.insert("ultrawarm".to_string(), Tag::Byte(0));
    dimension.insert("has_ceiling".to_string(), Tag::Byte(0));
